...
namespace gcgcg
{
  public class Mundo : GameWindow
  {
    ...
    protected override void OnLoad()
    {
      ...
      GL.ClearColor(0.416f, 0.404f, 0.620f, 1.0f);
      ...
      #endregion
      #region Objeto: ponto  
      objetoSelecionado = new Ponto(mundo, ref rotuloAtual, new Ponto4D(0))
      {
        PrimitivaTipo = PrimitiveType.Points,
        PrimitivaTamanho = 10
      };
      #endregion
      #region Objeto: círculo centrado na origem, raio 0.5, 72 pontos
