...
namespace gcgcg
{
    public class Mundo : GameWindow
    {
        ...
        private int indexPrimitivo = 0;
        private PrimitiveType[] tiposPrimitivos = { PrimitiveType.Points, PrimitiveType.Lines, PrimitiveType.LineLoop, PrimitiveType.LineStrip, PrimitiveType.Triangles, PrimitiveType.TriangleStrip, PrimitiveType.TriangleFan };
       ...
       0.0f,  0.0f,  0.0f, /* Y- */      0.0f,  0.5f,  0.0f, /* Y+ */
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            if (estadoTeclado.IsKeyPressed(Keys.Space))
                indexPrimitivo = (indexPrimitivo + 1) % tiposPrimitivos.Length;
                objetoSelecionado.PrimitivaTipo = tiposPrimitivos[indexPrimitivo];
